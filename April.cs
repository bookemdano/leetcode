...
namespace leetcode
{
    public class April
    {
        static public void Test()
        {
            ...
            Dessert.AssertSame(4, c.FurthestBuilding(new int[] { 4, 2, 7, 6, 9, 14, 12 }, 5, 1));
            Dessert.AssertSame(7, c.FurthestBuilding(new int[] { 4, 12, 2, 7, 3, 18, 20, 3, 19 }, 10, 2));
            Dessert.AssertSame(3, c.FurthestBuilding(new int[] { 14, 3, 19, 3 }, 17, 0));
            Dessert.AssertSame(1, c.FurthestBuilding(new int[] { 14, 3, 19, 3 }, 10, 0));
            Dessert.AssertSame(
                589,
                c.FurthestBuilding(
